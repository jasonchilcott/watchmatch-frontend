  ...
  editHandler = () => {
    if (this.state.editing === false) {
      ...
      <div className="profile">
        ...
        <br></br>
        <FaInstagram />{profile.instagram ? <a href={'https://instagram.com/' + profile.instagram } target="_blank" rel="noreferrer" className="profile-social">Instagram: @{profile.instagram}</a> 
